...
+ '         <property name="SelectedPropertiesJson" type="string">["ImageRenditionsOWSIMGE","ChemoursUrl","Path","AnnouncementDateOWSDATE","Title","NewsDescriptionOWSMTXT","SecondaryFileExtension","ContentTypeId"]</property> '
+ '         <property name="PropertyMappings" type="string">Picture URL{Picture URL}:ImageRenditionsOWSIMGE,Link URL{Link URL}:ChemoursUrl;Path,Line 1{Line 1}:AnnouncementDateOWSDATE,Line 2{Line 2}:Title,Line 3{Line 3}:NewsDescriptionOWSMTXT,SecondaryFileExtension,ContentTypeId</property> '
...
+ '         <property name="ItemTemplateId" type="string">~sitecollection/_catalogs/masterpage/Display Templates/Content Web Parts/Item_NewsandEvents.js</property> '
...
+ '         <property name="Title" type="string">News and Events</property> '
		...
		file.checkOut();
			...
			clientContext.executeQueryAsync(function() { 
				...
				deleteKeyCommunciationsWebPart(clientContext, limitedWebPartManager).done(function() {
					...
					limitedWebPartManager.addWebPart(wp.get_webPart(), "LeftColumn", webPartIndex);
...
var webPartTitle = "News and Events";
var webPartIndex = 10;
